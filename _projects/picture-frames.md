...
<div class="row blog">
    <div class="col-md-10 col-md-offset-4">
        ...
        <img width="100%" src="{{ page.picturePath }}/front-shot.png" />
        <p>
            I started off with milling the boards and cutting them to size.
            Once the boards are to size, I started with the long ends and cut a half lap joint into 
            each end with the table saw.  I do not have a dado blade, so did this in multiple passes.
            <img width="100%" src="{{ page.picturePath }}/process-shots_1.png" />
        </p>
        <p>
            After the half laps were done, I moved over to the miter saw and cut 45&deg; off of the ends.
            This finishes up the long sides.
            <img width="100%" src="{{ page.picturePath }}/process-shots_2.png" />
        </p>
        <p>
              Now I move over to work on the short sides.  On one end per board, 
            I use the miter guage on my table saw with the blade set to the same height as for the earlier half-laps.
            I cut out a 45&deg; half-lap in the short pieces up until a get to the 45 line from the corner of the board.
            <img width="100%" src="{{ page.picturePath }}/process-shots_3.png" />
            Then flip the miter guage and do the opposite end.
            <img width="100%" src="{{ page.picturePath }}/process-shots_4.png" />
        </p>
        <p>
            Once this is done, they go together like this.
            <img width="100%" src="{{ page.picturePath }}/process-shots_5.png" />
            <img width="100%" src="{{ page.picturePath }}/process-shots_6.png" />
        </p>
